...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create youtube-social-remix-8a1b
  fly apps create youtube-social-remix-8a1b-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app youtube-social-remix-8a1b
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app youtube-social-remix-8a1b-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'youtube-social-remix-8a1b-staging' does not match app name in config file 'youtube-social-remix-8a1b'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name youtube-social-remix-8a1b-db
  fly postgres attach --app youtube-social-remix-8a1b youtube-social-remix-8a1b-db

  fly postgres create --name youtube-social-remix-8a1b-staging-db
  fly postgres attach --app youtube-social-remix-8a1b-staging youtube-social-remix-8a1b-staging-db
  ```
